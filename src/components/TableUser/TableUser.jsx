      ...
      <table className="table-auto w-full dark:text-neutral-200 text-n-5">
        <thead className="dark:bg-n-7 bg-white text-base border-b dark:border-n-1/10 border-n-2/50 sticky top-0">
          <tr className="b-sky-700">
            <th className="text-start py-4 lg:w-[15%] 2xl:w-[10%]">Username</th>
            <th className="text-start py-4 lg:w-[15%] 2xl:w-[10%]">Gender</th>
            <th className="hidden lg:table-cell text-start py-4 lg:w-[27%] 2xl:w-[20%]">Phone</th>
            <th className="hidden lg:table-cell text-start py-4 lg:w-[27%] 2xl:w-[25%]">Address</th>
            <th className="hidden 2xl:table-cell text-start py-4 2xl:w-[10%]">Email</th>
            <th className="text-start py-4 lg:w-[16%] 2xl:w-[10%]">Action</th>
          </tr>
        </thead>

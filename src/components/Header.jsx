    ...
    <header className="dark:bg-n-7 bg-neutral-100 border border-n-1/10 dark:border-n-1/20 py-3 rounded-md px-5 flex items-center justify-between dark:text-neutral-100 text-n-5">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3">
          <ThemeSwitch />
          <MdOutlineChat size={20} className="cursor-pointer hover:text-logo transition-all duration-300" aria-label="Chat" role="button" />
          <MdNotifications size={20} className="cursor-pointer hover:text-logo transition-all duration-300" aria-label="Notifications" role="button" />
          <MdPublic size={20} className="cursor-pointer hover:text-logo transition-all duration-300" aria-label="Public" role="button" />
          {currentUser && (
